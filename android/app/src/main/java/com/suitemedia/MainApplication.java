  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.suitemedia.ReactNativeFlipper");
        aClass
...
// RNMmkv is not in a separate file bc it was causing problem when renaming project
class RNMmkv extends ReanimatedJSIModulePackage {
  @Override
